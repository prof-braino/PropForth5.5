...
# ./propeller-load -p /dev/ttyUSB0 -e  /home/braino/PropForth5.5/mygo/V5.5/kernels/MAKE/results/outputFiles/DevKernel.eeprom


./propeller-load -p /dev/ttyUSB0 -e -r /home/braino/PropForth5.5/mygo/V5.5/kernels/MAKE/referenceResults/outputFiles/DevKernel.eeprom
